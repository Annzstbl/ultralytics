...
experiment_name = 'yolov11l_8ch_CocoPretrain_table_imgsize1280_1gpu'


model = YOLO(model_cfg).load(load_multi_channel_pt(pt_file, 8, pt_file.replace('.pt', '_table_8ch.pt'), version='table'))
